...
features:
  ...
  - title: "Revenue Management"
    description: "Streamline collection, reporting, and forecasting of public funds."
  - title: "Expenditure Control"
    description: "Manage approvals, audits, and compliance checks."
  - title: "Financial Reporting"
    description: "Deliver timely, reliable reports for stakeholders and regulators."
  - title: "Asset & Resource Management"
    description: "Track and maintain public assets for long-term value."
  - title: "Compliance & Governance"
    description: "Ensure adherence to laws, policies, and audit standards."
...
whyChooseUs:
  - icon: "eye"
    ...
    text: "Every transaction is traceable, reducing leakages and building public trust."
  - icon: "activity"
    title: "Real-time monitoring"
    text: "Budgets, receipts, and expenditures tracked instantly for fiscal discipline."
  - icon: "shield-check"
    title: "Compliance built in"
    text: "Automated audit trails and reporting simplify regulatory alignment."
  - icon: "bar-chart-2"
    title: "Decision support"
    text: "Real-time dashboards and reports help policymakers act with confidence."
relatedServices: ["business-advisory", "quality-assurance"]
cta:
  heading: "Strengthen accountability in public finance"
